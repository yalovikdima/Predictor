...
struct ControlProperty<PropertyType> : ControlPropertyType {
    ...
    /// to property.
    init<Values: ObservableType, Sink: ObserverType>(values: Values, valueSink: Sink) where Element == Values.Element, Element == Sink.Element {
    ...
    var changed: ControlEvent<PropertyType> {
