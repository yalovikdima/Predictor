...
enum SharingScheduler {
    ...
    */
    static func mock(scheduler: SchedulerType, action: () throws -> Void) rethrows {
     ...
     **This shouldn't be used in normal release builds.**
     */
    static func mock(makeScheduler: @escaping () -> SchedulerType, action: () throws -> Void) rethrows {
