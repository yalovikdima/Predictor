...
*/
struct SharedSequence<SharingStrategy: SharingStrategyProtocol, Element> : SharedSequenceConvertibleType, ObservableConvertibleType {
 ...
 */
protocol SharingStrategyProtocol {
    /**
...
*/
protocol SharedSequenceConvertibleType : ObservableConvertibleType {
