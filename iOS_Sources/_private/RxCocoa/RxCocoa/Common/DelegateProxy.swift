...
import PredictorSDK_Private
    ...
    class DelegateProxy<P: AnyObject, D>: _RXPredictorDelegateProxy {
        typealias ParentObject = P
        ...
        init<Proxy: DelegateProxyType>(parentObject: ParentObject, delegateProxy: Proxy.Type)
         ...
         * there is no sensible automatic way to determine a default return value
         ...
         e.g.
             ...
             func requiredDelegateMethod(scrollView: UIScrollView, arg1: CGPoint) -> Bool {
         ...
         ....
             ...
             var property: Observable<CGPoint> {
        ...
        func setForwardToDelegate(_ delegate: Delegate?, retainDelegate: Bool) {
